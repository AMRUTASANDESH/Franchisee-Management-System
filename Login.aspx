...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Label ID="Label1" runat="server" Style="z-index: 100; left: 325px; position: absolute;
        top: 459px"></asp:Label>
    &nbsp;
 ...
 <tr>
        ...
        <tr>
            ...
            <td style="width: 100px">
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" Style="z-index: 100; left: 155px; position: absolute;
                    top: 141px" Font-Bold="True" Font-Italic="True" ForeColor="#400000" NavigateUrl="~/Register.aspx">Register</asp:HyperLink>
            </td>
        </tr>
    </table>
    &nbsp;
    <asp:Image ID="Image1" runat="server" ImageUrl="Images/Login.png" Style="z-index: 103;
        left: -58px; position: absolute; top: 211px" />
    <asp:Menu ID="Menu1" runat="server" BackColor="#FDFDFD" ForeColor="#F9BA2D" Height="249px"
        ...
        <Items>
            ...
            <asp:MenuItem NavigateUrl="~/Forgot Student ID.aspx" Text="Forgot Student ID" Value="Forgot Student ID">
            </asp:MenuItem>
            <asp:MenuItem NavigateUrl="~/Stu Forgot Password.aspx" Text="Forgot Password" Value="Forgot Password">
            </asp:MenuItem>
